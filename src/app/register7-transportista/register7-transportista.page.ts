...
@Component({
  selector: 'app-register7-transportista',
  templateUrl: './register7-transportista.page.html',
  styleUrls: ['./register7-transportista.page.scss'],
})
export class Register7TransportistaPage implements OnInit {
  params: any
  signData: any = {
    unidad: '',
    sub_unidad: '',
 ...
 async presentAlertConfirm() {
  ...
  next() {
    ...
    const state = {
      ...
      type: this.params ? this.params.type :'transportista',
      register1:this.params ? this.params.register1 :'',
      register2:this.params ? this.params.register2 :'',
      register3:this.params ? this.params.register3 :'',
      register4:this.params ? this.params.register4 :'',
      register5:this.params ? this.params.register5 :'',
      register6:this.params ? this.params.register6 :'',
      register7: this.signData,

    };
    this.router.navigateByUrl('/register8-transportista', { state });
  }
