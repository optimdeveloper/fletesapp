...
@Component({
  selector: 'app-register4-transportista',
  templateUrl: './register4-transportista.page.html',
  styleUrls: ['./register4-transportista.page.scss'],
})
export class Register4TransportistaPage implements OnInit {
  params:any
  signData:any={
    license:'',
    preventive:'',
  ...
  next(){
    ...
    this.router.navigateByUrl('/register5-transportista', { state });
  }
