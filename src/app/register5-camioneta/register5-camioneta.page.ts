...
@Component({
  selector: 'app-register5-camioneta',
  templateUrl: './register5-camioneta.page.html',
  styleUrls: ['./register5-camioneta.page.scss'],
})
export class Register5CamionetaPage implements OnInit {
  params:any
  signData:any={
    user_photo:'',
  }
  ...
  next(){
    ...
    this.router.navigateByUrl('/register6-camioneta', { state });
  }
