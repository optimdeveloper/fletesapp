...
@Component({
  selector: 'app-register3-transportista',
  templateUrl: './register3-transportista.page.html',
  styleUrls: ['./register3-transportista.page.scss'],
})
export class Register3TransportistaPage implements OnInit {
  signData:any={
    state:'',
    ife_front_photo:'',
    ife_back_photo:'',
  ...
  next(){
    ...
    this.router.navigateByUrl('/register4-transportista', { state });
  }
  takePhotoIFEFront(){
    this.ife_front=true
    this.ife_back=false
